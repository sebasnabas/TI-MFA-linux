...
#define TI_MFA_MPLS_EXTENSION_HDR \
	mpls_entry_encode(TI_MFA_MPLS_EXTENSION_LABEL, 255, 0, true);
...
static inline struct ti_mfa_link
ti_mfa_hdr_to_link(const struct ti_mfa_shim_hdr hdr)
{
	struct ti_mfa_link link;
