...
/* Parts copied from Linux Kernel 5.16
 * https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/?h=v5.16
 *
 * net/mpls/internal.h
 * {
*/
#ifndef TI_MFA_MPLS_LINUX_INTERNAL_H
#define TI_MFA_MPLS_LINUX_INTERNAL_H
...
#endif /* TI_MFA_MPLS_LINUX_INTERNAL_H */
