...
class NetworkTopo( Topo ):
    def build( self, **_ ): # pylint: disable=arguments-differ
        ...
        node_t, node_l, node_m, node_r, node_s = [
        ...
        self.addLink(node1=node_m, node2=node_s,
                     params1={ 'ip': '192.168.6.13/24' }, params2={ 'ip': '192.168.6.15/24' },
                     intfName1=f"{node_m}-eth4", intfName2=f"{node_s}-eth1")
...
def run(interactive=False):
    ...
    try:
        ...
        if interactive:
            ...
            net['T'].cmd('iperf3 -s -D -B 10.200.200.1')
